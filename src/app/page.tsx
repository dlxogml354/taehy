...
const works = [
  {
    ...
    description:
      'AI가 나의 시선과 행동을 모두 이해하는  미래는 어떤 세상일까요?\n본 연구는 미래 MR공간의 인터페이스 상호작용 설계전략을 제시합니다.',
    meta: '2025.07 ~ 2025.10  /  학위논문연구',
    href: '#',
  },
  {
    id: 2,
    ...
    meta: '2025.08  /  개인프로젝트(셔클)  /  인터뷰(100%), 서비스기획(100%)',
    href: '#',
  },
  {
    id: 3,
    ...
    meta: '2024.05 ~ 2024.10  /  산학협력(NDA)  /  인터뷰(40%), 가이드작성(60%)',
    href: '#',
  },
  {
    id: 4,
    ...
    description:
      '신규서비스 사용자들의 문제를 연구하고 \n지도기반 가맹점 정보제공 서비스를 고객데이터 기반으로 제시합니다.',
    meta: '2024.11  /  수업-기업연계(트래블월렛)  /  UX디자인(100%)',
    href: '#',
  },
]
